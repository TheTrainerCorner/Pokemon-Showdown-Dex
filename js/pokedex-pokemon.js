var PokedexPokemonPanel = PokedexResultPanel.extend({
    ...
    if (pokemon.tags.includes("Fakemon")) buf += `<img src="https://play.thetrainercorner.net/sprites/fakemons/${pokemon.spriteid.replace(/-/g, '')}.png" alt="" width="96" height="96" class="sprite" />`
